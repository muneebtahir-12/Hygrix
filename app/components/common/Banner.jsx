    ...
    <section className="relative mx-4 sm:mx-8 md:mx-16 lg:mx-28 xl:mx-32 bg-white overflow-hidden rounded-2xl sm:rounded-3xl">
      ...
      <div className="relative flex items-center justify-center px-4 sm:px-6 py-16 sm:py-20 md:py-24 lg:py-28">
        <div className="flex flex-col items-center text-center gap-4 sm:gap-5">
          ...
          <h2 className="text-[#171717] font-aeonik text-[26px] sm:text-[32px] md:text-[40px] lg:text-[53px] font-normal leading-snug max-w-[900px]">
            Healthcare, Simplified <br className="hidden sm:block" />
            You Can Focus on Living.
          </h2>

          <p className="text-[#171717] font-poppins text-[14px] sm:text-[15px] md:text-[17px] lg:text-[18px] font-normal leading-relaxed max-w-[720px]">
            We remove the stress and guesswork from healthcare, so you always feel
            informed, supported, and in control.
          </p>

          <div className="mt-3 flex items-center justify-center w-[120px] sm:w-[133px] h-[42px] sm:h-[46px] rounded-full bg-black cursor-pointer hover:bg-gray-900 transition">
