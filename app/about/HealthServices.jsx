...
export default function HealthServices() {
    return (
        <section className="bg-[#FCF2E580] h-auto relative overflow- flex flex-col">
            <Navbar />
            <div className="mt-10 sm:mx-10 md:mx-20 lg:mx-32 mx-5 flex-1 flex items-center">
                <div className="mx-auto w-full max-w-[1160px] rounded-3xl overflow-hidden h-full">
                    <div className="relative w-full h-full min-h-[320px] bg-center bg-cover" style={{backgroundImage: "url('/aboutbg.png')"}}>
