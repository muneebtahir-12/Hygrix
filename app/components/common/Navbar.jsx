...
export default function Navbar() {
  ...
  return (
    <nav className="relative">
      <section className="bg-white shadow-[0_20px_41.1px_0_rgba(0,0,0,0.05)] flex justify-between items-center mx-5 md:mx-20 lg:mx-30 lg:rounded-4xl px-5 py-3 mt-10 z-50 relative">
        ...
        <div className="hidden lg:flex items-center justify-center w-[110px] h-[43px] rounded-[100px] bg-black shadow-[-13px_22px_12.8px_0_rgba(255,255,255,0.25)] cursor-pointer hover:bg-gray-800 transition-all">
