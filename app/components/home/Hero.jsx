            ...
            <div className="object-cover h-[82vh]" style={{ backgroundImage: "url('/bg.png'),url('/bg2.png')" }}>
                ...
                <div className="bg-cover bg-center h-[500px] flex flex-col mx-10 sm:mx-18 md:mx-22 lg:mx-30 items-center justify-center w-full transition-all duration-300 -mt-12 md:-mt-10">
                    ...
                    <div className="relative w-full max-w-2xl ml-0 md:ml-30 lg:ml-30 -mt-50 sm:-mt-60 md:-mt-70 lg:-mt-115 space-y-4 flex flex-col items-center text-center transition-all duration-300">
                        ...
                        <div className="flex gap-2 sm:gap-3 md:gap-4 flex-wrap justify-center transition-all duration-300">
                        ...
                        <div className="flex gap-3 sm:gap-3 md:gap-4 items-center pt-1 sm:pt-1 md:pt-2 justify-center transition-all duration-300">
                            <div className="flex -space-x-2 sm:-space-x-2.5 md:-space-x-3 transition-all duration-300">
                                <img src="/Cus1.png" alt="" className="w-[28px] sm:w-[32px] md:w-[36px] h-[28px] sm:h-[32px] md:h-[36px] rounded-full border-2 border-white transition-all duration-300" />
                                <img src="/Cus2.png" alt="" className="w-[28px] sm:w-[32px] md:w-[36px] h-[28px] sm:h-[32px] md:h-[36px] rounded-full border-2 border-white transition-all duration-300" />
                                <img src="/Cus3.png" alt="" className="w-[28px] sm:w-[32px] md:w-[36px] h-[28px] sm:h-[32px] md:h-[36px] rounded-full border-2 border-white transition-all duration-300" />
                                <img src="/Cus4.png" alt="" className="w-[28px] sm:w-[32px] md:w-[36px] h-[28px] sm:h-[32px] md:h-[36px] rounded-full border-2 border-white transition-all duration-300" />
                            </div>
