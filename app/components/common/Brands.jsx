export default function Brands(){
    return(
        <section className="flex gap-3 flex-wrap mx-5 md:mx-20 lg:mx-30 items-center justify-between mt-20 ">
             ...
             <img src="/Brand5.png" alt="" className="w-[51.6px] h-[35.2px]" />
             <img src="/Brand6.png" alt="" className="w-[113px] h-[39.2px]" />
             <img src="/Brand7.png" alt="" className="w-[88.8px] h-[44.4px]" />
             <img src="/Brand8.png" alt="" className="w-[127.9px] h-[44.9px]" />
        </section>
    )
}